...
class Env3channel(gymnasium.Env):
    def __init__(self, data):
        super(Env3channel, self).__init__()
        ...
        self.observation_space = spaces.Box(low=-1, high=3, shape=(3, 13, 13), dtype=numpy.float32)
        self.reset()
    def reset(self, seed=None):
        ...
        observation = numpy.stack([foodgrid, selfgrid, oppgrid], axis=0)
        if self.debug:
            self.render()
            print("resetted")
        return observation, {}
